...
from .views import CrearProfesional, ListadoProfesional, EliminarProfesional, ActualizarProfesional
...
urlpatterns = [
    ...
    path('editar_profesional/<int:pk>', login_required(ActualizarProfesional.as_view()), name='editar_profesional'),
